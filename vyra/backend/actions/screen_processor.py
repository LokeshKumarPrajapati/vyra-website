...
def _get_api_key() -> str:
    ...
    # 2. Fall back to environment variable (consistent with rest of codebase)
    env_key = os.getenv("GEMINI_API_KEY", "")
    if env_key:
        return env_key

    raise RuntimeError(
        f"Could not load API key: neither {API_CONFIG_PATH} nor GEMINI_API_KEY env var found"
    )
...
class _LiveSession:
    ...
    def __init__(self):
        ...
        self._thread:    typing.Any = None
        self._session:   typing.Any = None
        self._out_queue: typing.Any = None
        self._audio_in:  typing.Any = None
        self._ready:     threading.Event = threading.Event()
        self._player:    typing.Any = None
        self._pya                   = pyaudio.PyAudio()
        self._send_lock: typing.Any = None
